...
// Verified stable models from MLC prebuilt config
const MODELS = [
  { id: "Qwen2.5-0.5B-Instruct-q4f16_1-MLC", name: "المصري السريع (Qwen 0.5B)", size: "~350MB", description: "خفيف جداً ومناسب للموبايلات" },
  { id: "Llama-3.2-1B-Instruct-q4f16_1-MLC", name: "المصري الذكي (Llama 3.2)", size: "~800MB", description: "متوازن جداً بين الذكاء والسرعة" },
  { id: "Phi-3.5-mini-instruct-q4f16_1-MLC", name: "العملاق (Phi 3.5)", size: "~2.3GB", description: "الأكثر قوة للأجهزة العالية فقط" },
];
